...
export class BusinessController {
    ...
    register = async (req: Request, res: Response) => {
        try {
            ...
            const user = await this.businessModel.getUserByEmail({
            ...
            const newBusiness: NewBusinessType = {
                ...result.data,
                password: hashedPassword,
            };

            const createdBusiness =
                await this.businessModel.create(newBusiness);
    ...
    registerUser = async (req: Request, res: Response) => {
        try {
            ...
            const createdUser = await this.businessModel.registerUser({
                businessId,
                newUser,
            });
            res.status(201).json({
